...
from lavis.util.pos_embed import get_2d_sincos_pos_embed
...
@registry.register_model("MaskedAutoencoderViT")
class MaskedAutoencoderViT(BaseModel):
    ...
    def __init__(self, vit_model=None, img_size=224, drop_path_rate=0.5, use_grad_checkpoint=False,
                 vit_precision = 'fp16', freeze_vit=True, num_query_token=1, t5_model=None,
                    prompt="", max_txt_len=128, max_output_txt_len=256, apply_lemmatizer=False,
                    num_few_shot_examples=0, few_shot_prob=0.0, qformer_text_input=True, num_frames=4):
                #  embed_dim=1024, depth=24, num_heads=16,
                #  decoder_embed_dim=512, decoder_depth=8, decoder_num_heads=16,
                #  mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False):
    ...
    def forward(self, imgs, mask_ratio=0.75):
        ...
        return_dict = {"loss": loss, "pred": pred, "image": imgs, 'mask': mask}
        return return_dict
